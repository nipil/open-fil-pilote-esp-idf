...
void test_storage(void)
{
    ...
    ESP_LOGE(TAG, "==== test storing data RAW =========================");
    ...
    ESP_LOGE(TAG, "==== test storing data MACRO =======================");
    ...
    ESP_LOGE(TAG, "==== test reading stored RAW =========================");
    h = kv_open_ns(ns);
    kv_get_i8(h, "i8", -1);
    kv_get_u8(h, "u8", +1);
    kv_get_i16(h, "i16", -1);
    ...
    ESP_LOGE(TAG, "==== test reading stored MACRO =========================");
    ...
    ESP_LOGE(TAG, "==== test read defaults RAW =========================");
    h = kv_open_ns(ns);
    kv_get_i8(h, "_i8", -1);
    kv_get_u8(h, "_u8", +1);
    kv_get_i16(h, "_i16", -1);
    ...
    ESP_LOGE(TAG, "==== test read defaults MACRO =========================");
